...
class Executor:
    ...
    def device_shell(self, command):
        return terminal(
            adb_dir + "-s " + self.device + " shell " + command,
            capture_output=True,
    ...
    def update_cache(self):
        ...
        if self.cache is None:
            terminal(
                ...
                + "-s "
                + self.device
                + " pull /sdcard/screencap.png ./.cache/screencap-"
                + _device
                + "-cache-1.png",
                creationflags=0x08000000,
            )  # pull that screenshot back to host at /.cache
        ...
        terminal(
            ...
            + "-cache-2.png",
            creationflags=0x08000000,
        )  # cache second image to comparing if game freezing
        if locateOnScreen(
            "./.cache/screencap-" + _device + "-cache-2.png",
            self.cache,
            minSearchTime=0,
            confidence=0.4 - float(f"0.{self.bonus_cutoff}"),
        ):
            self.freeze_count += 1
        shutil.copy(
            "./.cache/screencap-" + _device + "-cache-2.png",
            "./.cache/screencap-" + _device + "-cache-1.png",
        )
        self.cache = "./.cache/screencap-" + _device + "-cache-1.png"
    ...
    def is_on_screen(self, image, cutoff=0.4):
        return locateOnScreen(
            ...
            self.cache,
            minSearchTime=0,
            confidence=cutoff - float(f"0.{self.bonus_cutoff}"),
        )
    ...
    def verify_assets(self):
        ...
        try:
            ...
            self.assets_path = (
                "./assets/" + str(self.res[2]) + "x" + str(self.res[3]) + "/"
            )
        return
    ...
    def default_checks(self):
        ...
        current_window = self.device_shell(
    ...
    def login(self):
        ...
        while True:
            ...
            login_screens = [
                self.assets_path + "login/login_screen_1.png",
                self.assets_path + "login/login_screen_2.png",
            ]
            ...
            mission_buttons = [
                ...
                self.assets_path + "login/mission_2.png",
                self.assets_path + "login/mission_3.png",
                self.assets_path + "login/mission_4.png",
            ]
    ...
    def clear_shop(self):
        ...
        while True:
            ...
            menus = [
                self.assets_path + "clear_shop/menu_1.png",
                self.assets_path + "clear_shop/menu_2.png",
            ]
            for img in menus:
                if self.is_on_screen(img, 0.7):
                    self.tap(img, 0.7)
                    ...
                    while True:
                        ...
                        if self.update_cache() == "crash":
                            ...
                            self.tap(
                                self.assets_path + "clear_shop/error_confirm.png", 0.7
                            )
                            break
                    ...
                    while True:
                        ...
                        if resource == False and self.is_on_screen(
                            ...
                            while True:
                                ...
                                if self.is_on_screen(
                                    self.assets_path + "clear_shop/free_gold.png"
                                ):
                                    self.tap(
                                        self.assets_path + "clear_shop/free_gold.png"
                                    )
                                ...
                                if self.is_on_screen(
                                    self.assets_path + "clear_shop/free.png", 0.7
                                ):
                                    self.tap(
                                        self.assets_path + "clear_shop/free.png", 0.7
                                    )
                                    ...
                                    self.assets_path + "clear_shop/confirm.png", 0.7
                                ):
                                    self.tap(
                                        self.assets_path + "clear_shop/confirm.png", 0.7
                                    )
                        ...
                        if equipment == False and self.is_on_screen(
                            ...
                            while True:
                                ...
                                if self.is_on_screen(
                                    ...
                                    self.assets_path + "clear_shop/1000_coin.png", 0.7
                                ):
                                    self.tap(
                                        self.assets_path + "clear_shop/1000_coin.png",
                                        0.7,
                                    )
    ...
    def guild_attendance(self):
        ...
        while True:
            if self.update_cache() == "crash":
                ...
                self.assets_path + "guild_attendance/guild.png", 0.7
            ):
                ...
                while True:
                    ...
                    if self.is_on_screen(
                        ...
                        while True:
                            if receive_count >= 5:
                                while True:
                                    if self.update_cache() == "crash":
                                        ...
                                        self.assets_path
                                        + "guild_attendance/notice_return.png"
                                    ):
                                        self.tap(
                                            self.assets_path
                                            + "guild_attendance/confirm.png",
                                            0.7,
                                        )

                                    elif self.is_on_screen(
                                        self.assets_path + "guild_attendance/lobby.png",
                                        0.7,
                                    ):
                                        self.tap(
                                            self.assets_path
                                            + "guild_attendance/lobby.png",
                                            0.7,
                                        )
                            ...
                            if self.is_on_screen(
                                self.assets_path + "guild_attendance/chat.png", 0.8
                            ):
                                self.tap(
                                    self.assets_path + "guild_attendance/chat.png", 0.8
                                )
                                ...
                                if up == True:
                                    self.tap(
                                        self.assets_path + "guild_attendance/up.png",
                                        0.7,
                                        hold=1,
                                    )
                                    continue
                            ...
                            if self.is_on_screen(
                                self.assets_path + "guild_attendance/receive.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "guild_attendance/receive.png",
                                    0.7,
                                )
                            else:
                                receive_count += 1
                            ...
                            if self.is_on_screen(
                                self.assets_path + "guild_attendance/received.png", 0.6
                            ):
                                while True:
                                    if self.update_cache() == "crash":
                                        return "crash"
                            ...
                            if self.is_on_screen(
                                self.assets_path + "guild_attendance/confirm.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "guild_attendance/confirm.png",
                                    0.7,
                                )
                                while True:
                                    if self.update_cache() == "crash":
        ...
        while True:
            if count >= 3:
                while True:
                    ...
                    if self.is_on_screen(
                        self.assets_path + "colosseum/adventure.png", 0.7
                    ):
                        ...
                        self.assets_path + "colosseum/back.png", 0.7
                    ):
            ...
            if self.update_cache() == "crash":
            ...
            ) or self.is_on_screen(self.assets_path + "colosseum/fight_2.png", 0.7):
                ...
                while True:
                    if self.update_cache() == "crash":
                        ...
                        self.assets_path + "colosseum/not_enough.png"
                    ):
                        self.tap(
                            self.assets_path + "colosseum/caution_confirm.png", 0.7
                        )
                        count += 1
                        break
            ...
            if self.update_cache() == "crash":
                ...
                while True:
                    if self.update_cache() == "crash":
                        ...
                        while True:
                            if done_count >= 5:
                                while True:
                                    ...
                                    if self.is_on_screen(
                                        self.assets_path
                                        + "awakening_dungeon/adventure.png",
                                        0.7,
                                    ):
                                        ...
                                        self.assets_path + "awakening_dungeon/back.png",
                                        0.7,
                                    ):
                                        self.tap(
                                            self.assets_path
                                            + "awakening_dungeon/back.png",
                                            0.7,
                                        )
                            ...
                            if self.update_cache() == "crash":
                                ...
                                self.assets_path + "awakening_dungeon/sweep.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "awakening_dungeon/sweep.png",
                                    0.7,
                                )

                            elif self.is_on_screen(
                                self.assets_path + "awakening_dungeon/confirm.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "awakening_dungeon/confirm.png",
                                    0.7,
                                )
                                done = True
                                ...
                                self.assets_path
                                + "awakening_dungeon/sweep_unavailable.png"
                            ):
                                self.tap(
                                    self.assets_path + "awakening_dungeon/cancel.png",
                                    0.7,
                                )
                                while True:
                                    if self.update_cache() == "crash":
                        ...
                        self.assets_path + "awakening_dungeon/3_stars.png"
                    ):
                        if self.is_on_screen(
                            self.assets_path + "awakening_dungeon/confirm.png", 0.7
                        ):
                ...
                self.assets_path + "awakening_dungeon/recharge_ticket.png", 0.7
            ):
                while True:
                    if self.update_cache() == "crash":
                        return "crash"
    ...
    def sweep_dungeon(self, config):
        ...
        if config["sweep_dungeon"] == "Gold":
            ...
            dungeon = random(
                [
                    self.assets_path + "sweep_dungeon/gold_dungeon.png",
                    self.assets_path + "sweep_dungeon/exp_dungeon.png",
                    self.assets_path + "sweep_dungeon/item_dungeon.png",
                ]
            )
        ...
        while True:
            if count >= 10:
                while True:
                    ...
                    if self.is_on_screen(
                        self.assets_path + "sweep_dungeon/adventure.png", 0.7
                    ):
            ...
            if self.is_on_screen(
                ...
                while True:
                    if self.update_cache() == "crash":
                        ...
                        self.assets_path + "sweep_dungeon/+.png", 0.7
                    ):
                        ...
                        while True:
                            if done_count >= 5:
                                while True:
                                    ...
                                    if self.is_on_screen(
                                        ...
                                        self.tap(
                                            self.assets_path + "sweep_dungeon/back.png",
                                            0.7,
                                        )
                            ...
                            if self.update_cache() == "crash":
                                ...
                                self.assets_path + "sweep_dungeon/sweep.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "sweep_dungeon/sweep.png", 0.7
                                )
                                ...
                                self.assets_path + "sweep_dungeon/confirm.png", 0.7
                            ):
                                self.tap(
                                    self.assets_path + "sweep_dungeon/confirm.png", 0.7
                                )
                                ...
                                self.assets_path + "sweep_dungeon/sweep_unavailable.png"
                            ):
                                self.tap(
                                    self.assets_path + "sweep_dungeon/cancel.png", 0.7
                                )
                                while True:
                                    if self.update_cache() == "crash":
                                        return "crash"
                        ...
                        self.assets_path + "sweep_dungeon/3_stars.png"
                    ):
                        if self.is_on_screen(
                            self.assets_path + "sweep_dungeon/confirm.png", 0.7
                        ):
                            ...
                            while True:
                                ...
                                if self.is_on_screen(
                                    self.assets_path + "sweep_dungeon/adventure.png",
                                    0.7,
                                ):
                                    self._sweep_dungeon = True
                                    return
    ...
    def update_apk(self):
        self.log(
            "Game update required, process terminated, please update for game and run this script again"
        )
